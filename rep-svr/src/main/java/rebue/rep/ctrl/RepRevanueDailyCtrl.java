...
@RestController
@Slf4j
public class RepRevanueDailyCtrl {

    /**
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @Resource
    private RepRevanueDailySvc svc;
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @PostMapping("/rep/revanue-daily")
    IdRo add(@RequestBody final RepRevanueDailyMo mo) throws Exception {
        log.info("received post:/rep/revanue-daily");
        log.info("revanueDailyCtrl.add: {}", mo);
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @PutMapping("/rep/revanue-daily")
    Ro modify(@RequestBody final RepRevanueDailyMo mo) throws Exception {
        log.info("received put:/rep/revanue-daily");
        log.info("revanueDailyCtrl.modify: {}", mo);
        try {
            if (svc.modify(mo) == 1) {
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @DeleteMapping("/rep/revanue-daily")
    Ro del(@RequestParam("id") final java.lang.Long id) {
        log.info("received delete:/rep/revanue-daily");
        log.info("revanueDailyCtrl.del: {}", id);
    ...
    PageInfo<RepRevanueDailyMo> list(final RepRevanueDailyMo mo,
        ...
        log.info("list RepRevanueDailyMo:" + mo + ", pageNum = " + pageNum + ", pageSize = " + pageSize);
        if (pageSize > 50) {
            final String msg = "pageSize不能大于50";
            log.error(msg);
            throw new IllegalArgumentException(msg);
        }
        final PageInfo<RepRevanueDailyMo> result = svc.list(mo, pageNum, pageSize);
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @GetMapping("/rep/revanue-daily/get-by-id")
    RepRevanueDailyMo getById(@RequestParam("id") final java.lang.Long id) {
