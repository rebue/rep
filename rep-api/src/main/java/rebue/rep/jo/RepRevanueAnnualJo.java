...
/**
 * The persistent class for the REP_REVANUE_ANNUAL database table.
 * @mbg.generated 自动生成，如需修改，请删除本行
 */
@Entity
@Table(name = "REP_REVANUE_ANNUAL")
@Getter
@Setter
@ToString
public class RepRevanueAnnualJo implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RepRevanueAnnualJo other = (RepRevanueAnnualJo) obj;
        if (id == null) {
            if (other.id != null)
                return false;
