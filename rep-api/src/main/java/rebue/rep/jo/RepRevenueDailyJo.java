...
/**
 * The persistent class for the REP_REVENUE_DAILY database table.
 * @mbg.generated 自动生成，如需修改，请删除本行
 */
@Entity
@Table(name = "REP_REVENUE_DAILY")
@Getter
@Setter
@ToString
public class RepRevenueDailyJo implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RepRevenueDailyJo other = (RepRevenueDailyJo) obj;
        if (id == null) {
            if (other.id != null)
                return false;
